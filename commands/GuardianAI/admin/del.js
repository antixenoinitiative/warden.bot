...
if (process.env.GUILDID == botIdent().activeBot.guildId) {
    console.log("Removed del.js".cyan);
    return
}
...
let setRejectStart = null
if (botIdent().activeBot.botName == "GuardianAI") {
    ({ rejectStart, setRejectStart  } = require('../promotionRequest/requestpromotion'))
