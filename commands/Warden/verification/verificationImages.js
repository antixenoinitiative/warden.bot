...
const DEFAULT_IMAGE_GENERATION_CONFIG = {
    ...
    prompt: {
        ...
        curveNoiseCount: 0,
        pixelNoiseCount: 5200,
        decoyGlyphs: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789?/#%&',
        decoyGlyphCount: 76,
        decoyGlyphCountJitterRatio: 0.10,
        obfuscationLineCount: 9,
        obfuscationLineWidthMin: 1.5,
        obfuscationLineWidthMax: 16,
        obfuscationLineThinAlphaMax: 0.46,
        obfuscationLineThickAlphaMax: 0.10,
        obfuscationLineCurveAmount: 110,
        obfuscationLineAngleJitter: 18,
        occlusionLineCount: 0,
        ...
        characterOcclusionLineCountMin: 0,
        characterOcclusionLineCountMax: 0,
        ...
        textFillAlphaMin: 0.52,
        textFillAlphaMax: 0.68,
        ...
        occlusionLineDashChance: 0,
        occlusionLineUsePaletteColors: true,
        decoyGlyphAlphaMin: 0.28,
        decoyGlyphAlphaMax: 0.48,
...
function createGalleryStateFromQuestion(question, challengeId) {
    ...
    if (typeof taskModule.createGalleryState !== 'function') {
        throw new Error(`Question "${question?.id}" does not define a generated gallery image.`);
    }

    return taskModule.createGalleryState(question, {
        challengeId,
