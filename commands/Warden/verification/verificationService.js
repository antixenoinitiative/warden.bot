...
async function getCatalogQuestionChanges(guildId, challengeId, questionId, options) {
    return verificationDb.getCatalogQuestionChanges(
        await getVerificationSnapshot(guildId, options),
        challengeId,
        questionId,
    );
}
...
module.exports = {
    ...
    updateCatalogChallengeMetadata: verificationDb.updateCatalogChallengeMetadata,
    updateCatalogQuestionFields: verificationDb.updateCatalogQuestionFields,
    updateCatalogQuestionPrompt: verificationDb.updateCatalogQuestionPrompt,
    updateCatalogQuestionAnswers: verificationDb.updateCatalogQuestionAnswers,
    updateCatalogQuestionImageIds: verificationDb.updateCatalogQuestionImageIds,
    updateCatalogQuestionImageDirections: verificationDb.updateCatalogQuestionImageDirections,
    updateCatalogQuestionOptions: verificationDb.updateCatalogQuestionOptions,
    resetCatalogQuestionFieldsToTemplate: verificationDb.resetCatalogQuestionFieldsToTemplate,
