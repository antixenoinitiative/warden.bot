...
module.exports = {
    ...
    execute (interaction) {
        ...
        .addFields(
            ...
            {name: 'Gauss' ,value: 'Deal high Armor Piercing damage and kill hearts quickly. Mod Gauss is not better in any occasion as its stats are weaker than regular Gauss. Edge case being useful with small with small distros. Typically a weapon for high skill levels with added difficulty, nothing more.', inline: false},
        )
