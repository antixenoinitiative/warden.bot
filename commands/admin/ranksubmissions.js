...
module.exports = {
    ...
    async execute (interaction) {
        const file = new Discord.MessageAttachment('https://axicdn.s3.us-east-1.amazonaws.com/images/km2_explosion.png');
...
For more information, please visit the AXI ranks page on our website: https://antixenoinitiative.com/ranks`)
        ...
        interaction.channel.send({ embeds: [returnEmbed], files: [file] });
    }
}
