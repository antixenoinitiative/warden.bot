...
module.exports = {
    ...
    async execute (interaction) {
		...
		.setImage('https://ingcloud.blob.core.windows.net/public/images/km2_explosion.png')
		.setAuthor({ name: 'Anti-Xeno Initiative', iconURL: 'https://ingcloud.blob.core.windows.net/public/images/AXI_Insignia_Hypen_128.png', url: 'https://antixenoinitiative.com' })
