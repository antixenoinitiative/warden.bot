...
module.exports = {
    ...
    execute(message, args) {
    	const returnEmbed = new Discord.MessageEmbed()
      	...
      	.addField("**NOTE:** If a Nonhuman Signal Source has a Salvage Icon (cylinder) in the navigation panel, it will always be a solo Thargoid Interceptor.")
        ...
        .addComponents(new Discord.MessageButton().setLabel('NHSS').setStyle('LINK').setURL('https://wiki.antixenoinitiative.com/en/nhss'),)
